...
**Publikovaný detail — Proces 3 (Řešení požadavku):** [diagram z Camundy + textový popis BPMN](/reseni/ukol-4/proces-3-reseni-pozadavku).

**Publikovaný detail — Proces 4 (Vytvoření reportu):** [diagram z Camundy + textový popis BPMN](/reseni/ukol-4/proces-4-vytvoreni-reportu).
